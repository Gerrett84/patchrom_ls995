.class public Lcom/android/lgesettings/ZonePicker;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/lgesettings/ZonePicker$MyComparator;,
        Lcom/android/lgesettings/ZonePicker$ZoneSelectionListener;
    }
.end annotation
...
.field private mListener:Lcom/android/lgesettings/ZonePicker$ZoneSelectionListener;
...
.method public static constructTimezoneAdapter(Landroid/content/Context;Z)Landroid/widget/SimpleAdapter;
    ...
    invoke-static {p0, p1, v0}, Lcom/android/lgesettings/ZonePicker;->constructTimezoneAdapter(Landroid/content/Context;ZI)Landroid/widget/SimpleAdapter;
...
.method public static constructTimezoneAdapter(Landroid/content/Context;ZI)Landroid/widget/SimpleAdapter;
    ...
    :goto_0
    new-instance v6, Lcom/android/lgesettings/ZonePicker$MyComparator;

    invoke-direct {v6, v7}, Lcom/android/lgesettings/ZonePicker$MyComparator;-><init>(Ljava/lang/String;)V

    .line 104
    .local v6, comparator:Lcom/android/lgesettings/ZonePicker$MyComparator;
    invoke-static {p0}, Lcom/android/lgesettings/ZonePicker;->getZones(Landroid/content/Context;)Ljava/util/List;
    ...
    .end local v6           #comparator:Lcom/android/lgesettings/ZonePicker$MyComparator;
...
.method private static getZones(Landroid/content/Context;)Ljava/util/List;
    ...
    invoke-static {v5, v3, v2, v0, v1}, Lcom/android/lgesettings/ZonePicker;->addItem(Ljava/util/List;Ljava/lang/String;Ljava/lang/String;J)V
...
.method private setSorting(Z)V
    ...
    iget-object v0, p0, Lcom/android/lgesettings/ZonePicker;->mTimezoneSortedAdapter:Landroid/widget/SimpleAdapter;

    .line 210
    .local v0, adapter:Landroid/widget/SimpleAdapter;
    :goto_0
    invoke-virtual {p0, v0}, Lcom/android/lgesettings/ZonePicker;->setListAdapter(Landroid/widget/ListAdapter;)V

    .line 211
    iput-boolean p1, p0, Lcom/android/lgesettings/ZonePicker;->mSortedByTimezone:Z
    ...
    invoke-static {v0, v2}, Lcom/android/lgesettings/ZonePicker;->getTimeZoneIndex(Landroid/widget/SimpleAdapter;Ljava/util/TimeZone;)I
    ...
    .line 214
    invoke-virtual {p0, v1}, Lcom/android/lgesettings/ZonePicker;->setSelection(I)V
    ...
    :cond_1
    iget-object v0, p0, Lcom/android/lgesettings/ZonePicker;->mAlphabeticalAdapter:Landroid/widget/SimpleAdapter;
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    .line 153
    invoke-virtual {p0}, Lcom/android/lgesettings/ZonePicker;->getActivity()Landroid/app/Activity;
    ...
    invoke-static {v0, v1}, Lcom/android/lgesettings/ZonePicker;->constructTimezoneAdapter(Landroid/content/Context;Z)Landroid/widget/SimpleAdapter;

    move-result-object v1

    iput-object v1, p0, Lcom/android/lgesettings/ZonePicker;->mTimezoneSortedAdapter:Landroid/widget/SimpleAdapter;

    .line 159
    invoke-static {v0, v2}, Lcom/android/lgesettings/ZonePicker;->constructTimezoneAdapter(Landroid/content/Context;Z)Landroid/widget/SimpleAdapter;

    move-result-object v1

    iput-object v1, p0, Lcom/android/lgesettings/ZonePicker;->mAlphabeticalAdapter:Landroid/widget/SimpleAdapter;

    .line 162
    invoke-direct {p0, v2}, Lcom/android/lgesettings/ZonePicker;->setSorting(Z)V

    .line 163
    invoke-virtual {p0, v2}, Lcom/android/lgesettings/ZonePicker;->setHasOptionsMenu(Z)V
...
.method public onListItemClick(Landroid/widget/ListView;Landroid/view/View;IJ)V
    ...
    iget-object v5, p0, Lcom/android/lgesettings/ZonePicker;->mListener:Lcom/android/lgesettings/ZonePicker$ZoneSelectionListener;
    ...
    invoke-interface {v5, v3}, Lcom/android/lgesettings/ZonePicker$ZoneSelectionListener;->onZoneSelected(Ljava/util/TimeZone;)V
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 191
    :pswitch_0
    invoke-direct {p0, v0}, Lcom/android/lgesettings/ZonePicker;->setSorting(Z)V

    goto :goto_0

    .line 195
    :pswitch_1
    invoke-direct {p0, v1}, Lcom/android/lgesettings/ZonePicker;->setSorting(Z)V
...
.method public onPrepareOptionsMenu(Landroid/view/Menu;)V
    ...
    .line 177
    iget-boolean v0, p0, Lcom/android/lgesettings/ZonePicker;->mSortedByTimezone:Z
