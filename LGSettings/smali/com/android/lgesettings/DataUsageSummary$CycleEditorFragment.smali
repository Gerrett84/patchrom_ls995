.class public Lcom/android/lgesettings/DataUsageSummary$CycleEditorFragment;
...
.method public static show(Lcom/android/lgesettings/DataUsageSummary;)V
    ...
    .line 2398
    new-instance v1, Lcom/android/lgesettings/DataUsageSummary$CycleEditorFragment;

    invoke-direct {v1}, Lcom/android/lgesettings/DataUsageSummary$CycleEditorFragment;-><init>()V

    .line 2399
    .local v1, dialog:Lcom/android/lgesettings/DataUsageSummary$CycleEditorFragment;
    invoke-virtual {v1, v0}, Lcom/android/lgesettings/DataUsageSummary$CycleEditorFragment;->setArguments(Landroid/os/Bundle;)V

    .line 2400
    const/4 v2, 0x0

    invoke-virtual {v1, p0, v2}, Lcom/android/lgesettings/DataUsageSummary$CycleEditorFragment;->setTargetFragment(Landroid/app/Fragment;I)V
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/lgesettings/DataUsageSummary$CycleEditorFragment;->show(Landroid/app/FragmentManager;Ljava/lang/String;)V
...
.method public onCreateDialog(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    .line 2406
    invoke-virtual {p0}, Lcom/android/lgesettings/DataUsageSummary$CycleEditorFragment;->getActivity()Landroid/app/Activity;

    move-result-object v7

    .line 2407
    .local v7, context:Landroid/content/Context;
    invoke-virtual {p0}, Lcom/android/lgesettings/DataUsageSummary$CycleEditorFragment;->getTargetFragment()Landroid/app/Fragment;
    ...
    invoke-virtual {p0}, Lcom/android/lgesettings/DataUsageSummary$CycleEditorFragment;->getArguments()Landroid/os/Bundle;
    ...
    invoke-virtual {v3, v4}, Lcom/android/lgesettings/net/NetworkPolicyEditor;->getPolicyCycleDay(Landroid/net/NetworkTemplate;)I
    ...
    new-instance v0, Lcom/android/lgesettings/DataUsageSummary$CycleEditorFragment$1;

    move-object v1, p0

    invoke-direct/range {v0 .. v5}, Lcom/android/lgesettings/DataUsageSummary$CycleEditorFragment$1;-><init>(Lcom/android/lgesettings/DataUsageSummary$CycleEditorFragment;Landroid/widget/NumberPicker;Lcom/android/lgesettings/net/NetworkPolicyEditor;Landroid/net/NetworkTemplate;Lcom/android/lgesettings/DataUsageSummary;)V
