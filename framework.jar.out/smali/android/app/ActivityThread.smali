...
.method final applyConfigurationToResourcesLocked(Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)Z
    ...
    invoke-static {v8, v0}, Landroid/app/MiuiThemeHelper;->handleExtraConfigurationChanges(ILandroid/content/res/Configuration;)V
...
.method getTopLevelResources(Ljava/lang/String;ILandroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)Landroid/content/res/Resources;
    ...
    .prologue
    .line 1664
    new-instance v9, Landroid/app/ActivityThread$ResourcesKey;
    ...
    invoke-direct {v9, v0, v1, v2, v13}, Landroid/app/ActivityThread$ResourcesKey;-><init>(Ljava/lang/String;ILandroid/content/res/Configuration;F)V

    .line 1668
    .local v9, key:Landroid/app/ActivityThread$ResourcesKey;
    move-object/from16 v0, p0

    iget-object v14, v0, Landroid/app/ActivityThread;->mPackages:Ljava/util/HashMap;
    ...
    iget-object v13, v0, Landroid/app/ActivityThread;->mActiveResources:Ljava/util/HashMap;
    ...
    invoke-virtual {v13}, Landroid/content/res/AssetManager;->isUpToDate()Z
    ...
    .restart local v11       #r:Landroid/content/res/Resources;
    .restart local v12       #wr:Ljava/lang/ref/WeakReference;,"Ljava/lang/ref/WeakReference<Landroid/content/res/Resources;>;"
    :cond_2
    :try_start_2
    invoke-static {}, Landroid/app/ActivityThread;->getPackageManager()Landroid/content/pm/IPackageManager;
    ...
    invoke-interface {v7, v0}, Landroid/content/pm/IPackageManager;->getOverlayPath(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v3, v0, v10}, Landroid/content/res/AssetManager;->addOverlayPath(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_2
    .catch Landroid/os/RemoteException; {:try_start_2 .. :try_end_2} :catch_0
    ...
    invoke-virtual {v0, v1, v13}, Landroid/app/ActivityThread;->getDisplayMetricsLocked(ILandroid/content/res/CompatibilityInfo;)Landroid/util/DisplayMetrics;
    ...
    #getter for: Landroid/app/ActivityThread$ResourcesKey;->mOverrideConfiguration:Landroid/content/res/Configuration;
    invoke-static {v9}, Landroid/app/ActivityThread$ResourcesKey;->access$3000(Landroid/app/ActivityThread$ResourcesKey;)Landroid/content/res/Configuration;
    ...
    invoke-virtual {v0, v5, v4}, Landroid/app/ActivityThread;->applyNonDefaultDisplayMetricsToConfigurationLocked(Landroid/util/DisplayMetrics;Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v4, v13}, Landroid/content/res/Configuration;->updateFrom(Landroid/content/res/Configuration;)I

    .line 1725
    :cond_6
    :goto_4
    new-instance v11, Landroid/content/res/MiuiResources;

    .end local v11           #r:Landroid/content/res/Resources;
    move-object/from16 v0, p4

    invoke-direct {v11, v3, v5, v4, v0}, Landroid/content/res/MiuiResources;-><init>(Landroid/content/res/AssetManager;Landroid/util/DisplayMetrics;Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)V
    ...
    iget-boolean v13, v0, Landroid/app/ActivityThread;->mThemeIconEnabled:Z

    if-eqz v13, :cond_b

    .line 1743
    new-instance v13, Landroid/content/thm/ThemeIconManager;

    invoke-direct {v13, v11}, Landroid/content/thm/ThemeIconManager;-><init>(Landroid/content/res/Resources;)V

    invoke-virtual {v11, v13}, Landroid/content/res/Resources;->setThemeIconManager(Landroid/content/thm/ThemeIconManager;)V
