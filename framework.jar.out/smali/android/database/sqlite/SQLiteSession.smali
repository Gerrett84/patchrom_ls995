...
# virtual methods
.method public backupDB(Ljava/lang/String;ILandroid/os/CancellationSignal;)I
    .locals 1
    .parameter "path"
    .parameter "connectionFlags"
    .parameter "cancellationSignal"
    ...
    invoke-direct {p0, v0, p2, p3}, Landroid/database/sqlite/SQLiteSession;->acquireConnection(Ljava/lang/String;ILandroid/os/CancellationSignal;)V

    .line 905
    :try_start_0
    iget-object v0, p0, Landroid/database/sqlite/SQLiteSession;->mConnection:Landroid/database/sqlite/SQLiteConnection;

    invoke-virtual {v0, p1}, Landroid/database/sqlite/SQLiteConnection;->backupDB(Ljava/lang/String;)I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public totalChangeCount(ILandroid/os/CancellationSignal;)I
    .locals 1
    .parameter "connectionFlags"
    .parameter "cancellationSignal"
    ...
    invoke-direct {p0, v0, p1, p2}, Landroid/database/sqlite/SQLiteSession;->acquireConnection(Ljava/lang/String;ILandroid/os/CancellationSignal;)V

    .line 894
    :try_start_0
    iget-object v0, p0, Landroid/database/sqlite/SQLiteSession;->mConnection:Landroid/database/sqlite/SQLiteConnection;

    invoke-virtual {v0}, Landroid/database/sqlite/SQLiteConnection;->totalChangeCount()I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
