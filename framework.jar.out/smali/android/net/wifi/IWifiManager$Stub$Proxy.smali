...
.method public getWifiVZWApConfiguration()Landroid/net/wifi/WifiVZWConfiguration;
    ...
    .line 1343
    sget-object v3, Landroid/net/wifi/WifiVZWConfiguration;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-interface {v3, v1}, Landroid/os/Parcelable$Creator;->createFromParcel(Landroid/os/Parcel;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Landroid/net/wifi/WifiVZWConfiguration;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 1350
    .local v2, _result:Landroid/net/wifi/WifiVZWConfiguration;
    :goto_0
    invoke-virtual {v1}, Landroid/os/Parcel;->recycle()V
    ...
    .line 1346
    .end local v2           #_result:Landroid/net/wifi/WifiVZWConfiguration;
    :cond_0
    const/4 v2, 0x0

    .restart local v2       #_result:Landroid/net/wifi/WifiVZWConfiguration;
    goto :goto_0
...
.method public setWifiVZWApConfiguration(Landroid/net/wifi/WifiVZWConfiguration;)V
    ...
    invoke-virtual {p1, v0, v2}, Landroid/net/wifi/WifiVZWConfiguration;->writeToParcel(Landroid/os/Parcel;I)V
...
.method public setWifiVZWApEnabled(Landroid/net/wifi/WifiVZWConfiguration;Z)V
    ...
    invoke-virtual {p1, v0, v4}, Landroid/net/wifi/WifiVZWConfiguration;->writeToParcel(Landroid/os/Parcel;I)V
