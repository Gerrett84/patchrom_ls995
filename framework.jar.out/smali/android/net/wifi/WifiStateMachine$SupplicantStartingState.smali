...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v2}, Landroid/net/wifi/WifiStateMachine;->access$5000(Landroid/net/wifi/WifiStateMachine;)Landroid/net/wifi/WifiInfo;
    ...
    invoke-static {v2, v0}, Landroid/net/wifi/WifiStateMachine;->access$5102(Landroid/net/wifi/WifiStateMachine;I)I
    ...
    #setter for: Landroid/net/wifi/WifiStateMachine;->mLastSignalLevel_LG:I
    ...
    const-string v2, " mWifiInfo.getMacAddress() return NULL ."
    ...
    invoke-static {v0}, Landroid/net/wifi/WifiStateMachine;->access$700(Landroid/net/wifi/WifiStateMachine;)Lcom/lge/wifi_iface/WifiServiceExtIface;

    move-result-object v0

    invoke-interface {v0}, Lcom/lge/wifi_iface/WifiServiceExtIface;->checkAutoConnectProfile()V
    ...
    invoke-static {v0, v1}, Landroid/net/wifi/WifiStateMachine;->access$5800(Landroid/net/wifi/WifiStateMachine;Z)V
    ...
    invoke-static {v2}, Landroid/net/wifi/WifiStateMachine;->access$5104(Landroid/net/wifi/WifiStateMachine;)I
    ...
    #calls: Landroid/net/wifi/WifiStateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v2, v3}, Landroid/net/wifi/WifiStateMachine;->access$6200(Landroid/net/wifi/WifiStateMachine;Lcom/android/internal/util/IState;)V
