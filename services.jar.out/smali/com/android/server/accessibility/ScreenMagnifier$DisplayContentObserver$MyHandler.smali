...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v6}, Lcom/android/server/accessibility/ScreenMagnifier$DisplayContentObserver;->access$2800(Lcom/android/server/accessibility/ScreenMagnifier$DisplayContentObserver;)Lcom/android/server/accessibility/ScreenMagnifier$Viewport;
    ...
    invoke-static {v6}, Lcom/android/server/accessibility/ScreenMagnifier$DisplayContentObserver;->access$2900(Lcom/android/server/accessibility/ScreenMagnifier$DisplayContentObserver;)Landroid/graphics/Rect;
    ...
    #getter for: Lcom/android/server/accessibility/ScreenMagnifier$DisplayContentObserver;->mTempRect:Landroid/graphics/Rect;
    invoke-static {v7}, Lcom/android/server/accessibility/ScreenMagnifier$DisplayContentObserver;->access$2900(Lcom/android/server/accessibility/ScreenMagnifier$DisplayContentObserver;)Landroid/graphics/Rect;
    ...
    invoke-static {v6, v7, v2}, Lcom/android/server/accessibility/ScreenMagnifier$DisplayContentObserver;->access$3000(Lcom/android/server/accessibility/ScreenMagnifier$DisplayContentObserver;Landroid/graphics/Rect;Z)V
    :try_end_0
    ...
    invoke-static {v6, v5, v3}, Lcom/android/server/accessibility/ScreenMagnifier$DisplayContentObserver;->access$3100(Lcom/android/server/accessibility/ScreenMagnifier$DisplayContentObserver;ILandroid/view/WindowInfo;)V
    ...
    invoke-static {v6, v4}, Lcom/android/server/accessibility/ScreenMagnifier$DisplayContentObserver;->access$3200(Lcom/android/server/accessibility/ScreenMagnifier$DisplayContentObserver;I)V
    ...
    invoke-static {v7}, Lcom/android/server/accessibility/ScreenMagnifier$DisplayContentObserver;->access$3300(Lcom/android/server/accessibility/ScreenMagnifier$DisplayContentObserver;)Lcom/android/server/accessibility/ScreenMagnifier$MagnificationController;
